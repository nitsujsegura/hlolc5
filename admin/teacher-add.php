...
if (isset($_SESSION['admin_id'])) {
       ...
       $query2 = "SELECT *FROM teachers ORDER BY username DESC LIMIT 1";
       $res= mysqli_query($db,$query2);
       if($res){
       $row = $res->fetch_array(MYSQLI_ASSOC);
       $last_id = $row['username'];
       if($last_id == NULL){
        
          $newrollno= "91010001";
        }
        else{
            $newrollno= str_replace("9101000","",$last_id);
            $newrollno= str_pad($newrollno+1,0);
            $newrollno= "9101000". $newrollno;
        }
      ...
      if(isset($_POST['submit'])){
        $newrollno=$_POST['username'];
        $insert = "INSERT INTO 'students'('username) VALUES ('$newrollno')";
      }
 ?>
<!DOCTYPE html>
<html lang="en">
